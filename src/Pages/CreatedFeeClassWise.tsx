...
const CreatedFeeClassWise: React.FC<AllProps> = ({ onLogout, isOpen = false }) => {
            ...
            <div className="border border-customBlue bg-[#DEEBF4] rounded p-5">
              <div  className={
                ...
                <div className="col-span-1 flex items-center">
                  <label className="text-zinc-900 text-xs lg:text-base md:font-medium xl:[30%] lg:w-[32%] md:w-[25%] sm:w-[39%] w-[33%]">
                    Period:
                  </label>
                  <select
                    name="period"
...
export default CreatedFeeClassWise;