...
const CreateFeeAll: React.FC<AllProps> = ({ onLogout, isOpen = false }) => {
  ...
  return (
    <div className="m-auto">
      <Navbar title="Create Fee All" onLogout={onLogout} />
      <div className="p-5">
        <form className="border border-customBlue rounded bg-[#EAF1F6] rounded xl:max-w-[90%] m-auto p-8">
          ...
          <div className="border border-customBlue bg-[#DEEBF4] rounded p-5 mt-5">
            ...
            >
              ...
              <div className="sm:col-span-1 col-span-2 flex items-center lg:gap-[77px] md:gap-[35px] sm:gap-[38px] gap-[22px]">
            ...
            <div className="shadow shadow-zinc-400 mt-10 mb-3 p-3">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full lg:px-3 px-1 md:p-1 border border-customBlue focus:bg-gray-200 rounded focus:outline-none active:border-blue-500"
              type="text"
            />
            {renderErrorMessages()}
            <div className="mt-5 flex flex-wrap justify-between gap-2">
              <div className="flex justify-start">
                <button className="px-1 py-1 lg:w-[120px] w-[100px] text-sm md:text-base lg:text-lg border border-customBlue bg-white rounded font-medium shadow-md hover:bg-blue-800 text-black hover:text-white active:shadow-inner transform active:translate-y-0.5">
                  Delete Fee
                </button>
              </div>
              <div className="flex justify-end gap-3">
                <button
                  type="button"
                  onClick={handleSave}
                  className="px-1 py-1 w-[100px] text-sm md:text-base lg:text-lg border border-customBlue bg-white rounded font-medium shadow-md hover:bg-blue-800 text-black hover:text-white active:shadow-inner transform active:translate-y-0.5"
                >
                  Create Fee
                </button>
                <button className="px-1 py-1 w-[100px] text-sm md:text-base lg:text-lg border border-customBlue bg-white rounded font-medium shadow-md hover:bg-blue-800 text-black hover:text-white active:shadow-inner transform active:translate-y-0.5">
                  Exit
                </button>
              </div>
            </div>
