...
const AllFeeChallans: React.FC<AllProps> = ({ onLogout, isOpen = false }) => {
  ...
  const inputStyle = (fieldName: keyof FormErrors) => `
    flex-grow p-0 lg:px-3 px-1 md:p-1 border 
  ...
  return (
    <div className="m-auto">
      <Navbar title="All Fee Challans" onLogout={onLogout} />
      <div className="p-5">
