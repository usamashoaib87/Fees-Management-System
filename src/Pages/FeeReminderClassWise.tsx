...
const FeeReminderClassWise: React.FC<AllProps> = ({ onLogout, isOpen = false }) => {
  ...
  return (
    <div className="m-auto">
      <Navbar title="Fee Reminder (Classwise)" onLogout={onLogout} />
      <div className="p-5">
...
export default FeeReminderClassWise;