...
const CreatedFeeClassSection: React.FC<AllProps> = ({ onLogout, isOpen = false }) => {
  ...
  return (
    <div className="m-auto">
      <Navbar title="Fee Class/Section" onLogout={onLogout} />
      <div className="p-5">
...
export default CreatedFeeClassSection;