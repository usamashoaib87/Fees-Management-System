...
interface FormErrors {
  concessionId: boolean;
  description: boolean;
}

const DefineConcessionTypes: React.FC<AllProps> = ({
  onLogout,
  isOpen = false,
}) => {
  ...
  const renderErrorMessages = () => {
    const errorMessages = [];
    if (formErrors.concessionId)
      errorMessages.push("Concession ID is Required");
  ...
  return (
    <div className="m-auto">
      <Navbar title="Concession Types" onLogout={onLogout} />
      <div className="p-5">
            ...
            <div className={isOpen ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 transition-all duration-300":"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-3 transition-all duration-300"}>
              <div className="sm:col-span-1 col-span-2 flex items-center">
                ...
                <input
                  ...
                  className={inputStyle("concessionId")}
                  type="text"
                />
              </div>
              <div className="sm:col-span-1 col-span-2 flex items-center">
...
export default DefineConcessionTypes;
